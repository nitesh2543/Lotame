 ...
 */
public class DramaListFragment extends RecyclerViewFragment implements RecyclerViewEvents.Listener<SectionItems>, ViewModel.ResponseListener<Results> {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ListAdapter(getContext(), list, this, R.layout.adapter_drama_list_item);
